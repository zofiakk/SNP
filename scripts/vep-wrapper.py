...
__copyright__ = "Copyright 2020, Johannes K??ster"
...
warningf = snakemake.output.warningf
...
if cache:
    ...
    release, build = [entrypath.name.split("_")[0], "_".join(entrypath.name.split("_")[1:])]
    cache = (
